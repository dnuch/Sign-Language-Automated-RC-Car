...
class ServoConvert():
    def __init__(self, id=1, throttle_center_value=310, 
                 steer_center_value=310, range=90, direction=1):
        self.value            = 0.0
        self.value_out        = 333
        self._throttle_center = throttle_center_value
        self._steer_center    = steer_center_value
        self._range           = range
    ...
    def get_value_out(self, value_in, is_throttle = True):
        #--- value is in [-1, 1]
        self.value      = value_in
        self.value_out  = int(self._dir*value_in*self._half_range + 
                         (self._throttle_center if is_throttle else self._steer_center))
...
class DkLowLevelCtrl():
    ...
    def set_actuators_from_cmdvel(self, message):
        ...
        self.actuators['steering'].get_value_out(message.angular.z, False)
    ...
    def set_actuators_idle(self):
        ...
        self.actuators['steering'].get_value_out(0, False)
